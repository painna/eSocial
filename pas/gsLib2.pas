...
Uses
 ...
 Forms, Dialogs, stdCtrls, DBClient, Graphics, Db, SqlExpr, JPEG, Mask,
 DbCtrls, ExtCtrls, ShellApi, IniFiles;
...
uses Variants, StrUtils, udmPrincipal2, VarGlobais, UtilsDb2, Windows;
