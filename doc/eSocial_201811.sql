...
/*------ SYSDBA 27/11/2018 21:55:54 --------*/

CREATE TABLE ESOCIAL_FECH_PERIODICO (
    EVENTO INTEGER NOT NULL,
    COMPETENCIA INTEGER NOT NULL,
    DATA_ENVIO "DATE",
    USUARIO_ENVIO "DATE",
    PROTOCOLO "VARCHAR(30)",
    POSSUI_REMUNERACAO SIM_NAO,
    POSSUI_PAGTOS_1210 SIM_NAO,
    POSSUI_AQUISICAO_PRODUTO_1250 SIM_NAO,
    POSSUI_PRODUCAO_1260 SIM_NAO,
    POSSUI_CONTRATO_AVULSO_1270 SIM_NAO,
    POSSUI_DESONERACAO_1280 SIM_NAO);

ALTER TABLE ESOCIAL_FECH_PERIODICO
ADD CONSTRAINT PK_ESOCIAL_FECH_PERIODICO
PRIMARY KEY (EVENTO,COMPETENCIA);

COMMENT ON COLUMN ESOCIAL_FECH_PERIODICO.PROTOCOLO IS
'Protocolo retornado para o envio de evento S1299.';



/*------ 27/11/2018 21:56:26 --------*/

GRANT ALL ON ESOCIAL_FECH_PERIODICO TO "GERASYS.TI" WITH GRANT OPTION;

/*------ 27/11/2018 21:56:26 --------*/

GRANT ALL ON ESOCIAL_FECH_PERIODICO TO GERASYSTI WITH GRANT OPTION;

/*------ 27/11/2018 21:56:26 --------*/

GRANT ALL ON ESOCIAL_FECH_PERIODICO TO PUBLIC;

/*------ 27/11/2018 21:56:26 --------*/

GRANT ALL ON ESOCIAL_FECH_PERIODICO TO PUBLIC WITH GRANT OPTION;


/*------ SYSDBA 27/11/2018 21:58:44 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO DROP CONSTRAINT PK_ESOCIAL_FECH_PERIODICO;




/*------ SYSDBA 27/11/2018 21:59:07 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO DROP COMPETENCIA;




/*------ SYSDBA 27/11/2018 21:59:12 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO DROP EVENTO;




/*------ SYSDBA 27/11/2018 21:59:42 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
    ADD EVENTO "VARCHAR(10)" NOT NULL,
    ADD COMPETENCIA "CHAR(6)" NOT NULL;
...
alter table ESOCIAL_FECH_PERIODICO
alter DATA_ENVIO position 3;

alter table ESOCIAL_FECH_PERIODICO
alter USUARIO_ENVIO position 4;

alter table ESOCIAL_FECH_PERIODICO
alter PROTOCOLO position 5;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_REMUNERACAO position 6;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_PAGTOS_1210 position 7;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_AQUISICAO_PRODUTO_1250 position 8;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_PRODUCAO_1260 position 9;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_CONTRATO_AVULSO_1270 position 10;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_DESONERACAO_1280 position 11;




/*------ SYSDBA 27/11/2018 21:59:51 --------*/
...
/*------ SYSDBA 27/11/2018 22:20:48 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
    ADD SEM_MOVIMENTO COMPUTED BY (Case when ((POSSUI_REMUNERACAO = 'S') or (POSSUI_PAGTOS_1210 = 'S') or (POSSUI_AQUISICAO_PRODUTO_1250 = 'S') or (POSSUI_PRODUCAO_1260 = 'S') or (POSSUI_CONTRATO_AVULSO_1270 = 'S') or (POSSUI_DESONERACAO_1280 = 'S'))
  then 'N'
  else 'S'
end);
...
/*------ SYSDBA 27/11/2018 22:21:53 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
    ADD COM_MOVIMENTO COMPUTED BY (Case when ((POSSUI_REMUNERACAO = 'S') or (POSSUI_PAGTOS_1210 = 'S') or (POSSUI_AQUISICAO_PRODUTO_1250 = 'S') or (POSSUI_PRODUCAO_1260 = 'S') or (POSSUI_CONTRATO_AVULSO_1270 = 'S') or (POSSUI_DESONERACAO_1280 = 'S'))
  then 'S'
  else 'N'
end);
...
/*------ SYSDBA 27/11/2018 22:23:59 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
ADD CONSTRAINT UNQ_ESOCIAL_FECH_PERIODICO
UNIQUE (PROTOCOLO);




/*------ SYSDBA 27/11/2018 22:25:22 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
    ADD FECHADO SIM_NAO;

COMMENT ON COLUMN ESOCIAL_FECH_PERIODICO.FECHADO IS
'Fechamento periodico S1299 executado:
N - Nao
S - Sim';
...
alter table ESOCIAL_FECH_PERIODICO
alter FECHADO position 3;

alter table ESOCIAL_FECH_PERIODICO
alter DATA_ENVIO position 4;

alter table ESOCIAL_FECH_PERIODICO
alter USUARIO_ENVIO position 5;

alter table ESOCIAL_FECH_PERIODICO
alter PROTOCOLO position 6;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_REMUNERACAO position 7;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_PAGTOS_1210 position 8;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_AQUISICAO_PRODUTO_1250 position 9;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_PRODUCAO_1260 position 10;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_CONTRATO_AVULSO_1270 position 11;

alter table ESOCIAL_FECH_PERIODICO
alter POSSUI_DESONERACAO_1280 position 12;

alter table ESOCIAL_FECH_PERIODICO
alter SEM_MOVIMENTO position 13;

alter table ESOCIAL_FECH_PERIODICO
alter COM_MOVIMENTO position 14;




/*------ SYSDBA 27/11/2018 22:47:32 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
ADD CONSTRAINT FK_ESOCIAL_FECH_PERIODICO_1
...
/*------ SYSDBA 27/11/2018 22:54:39 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO ALTER COLUMN USUARIO_ENVIO TYPE "VARCHAR(20)";




/*------ SYSDBA 27/11/2018 23:10:05 --------*/

ALTER TABLE ESOCIAL_FECH_PERIODICO
    ADD COMPETENCIA_ID COMPUTED BY (cast(COMPETENCIA as Integer));



/*------ SYSDBA 27/11/2018 23:13:26 --------*/
